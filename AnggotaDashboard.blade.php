...
@section('judul')
   <h2 class="text-primary"> Selamat Datang di E-perpus, {{ Auth::user()->name }}</h2>
@endsection
...
<div class="col-xl-3 col-md-6 mb-4">
    ...
    <div class="container">
        <h3 class="text-light"> <i class="fa-solid fa-circle-info text-light my-3"></i>  rules Peminjaaman</h3>
        <ol class=text-light>
            <li class=text-light>Waktu peminjaman maksimal 3 hari</li>
            <li class=text-light>Setiap siswa hanya dapat meminjam maksima 2 buku</li>
            <li class=text-light>Jika pengenbalian buku lebih dari waktu yang ditentukan akan diberikan denda setiap buku Rp.3000/minggu.</li>
            <li class=text-light>Jika Terlambat mengembalikan buku dan mendapat denda, maka wajib langsung membayar pada jamil saat mengembalikan buku</li>
        </ol>
    </div>
    </div>
@endsection
